...
describe('NetworkState', function() {
    it('should return a network state object', function() {
        let s = state.create();
    ...
    it('should add a NetworkState to the global state', function() {
        let s = state.create();
        let network = s.addNetwork('TestNetwork', 'TestNick', {
            server: 'irc.irc.com',
        });
    ...
    it('should retrieve a NetworkState from the global state', function() {
        let s = state.create();
        let network = s.addNetwork('TestNetwork', 'TestNick', {
            server: 'irc.irc.com',
        });
    ...
    it('automatically has a server buffer', function() {
        let s = state.create();
        let network = s.addNetwork('TestNetwork', 'TestNick', {});
    ...
    it('correctly adds buffers', function() {
        let s = state.create();
        let network = s.addNetwork('TestNetwork', 'TestNick', {});
    ...
    it('correctly stores local network settings', function() {
        let s = state.create();
        let network = s.addNetwork('TestNetwork', 'TestNick', {});

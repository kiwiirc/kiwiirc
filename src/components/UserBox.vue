    ...
    <div class="kiwi-userbox">
        ...
        <div v-if="buffer.isChannel() && areWeAnOp" class="kiwi-userbox-actions-op">
            <form class="u-form" @submit.prevent="">
                ...
                <label v-if="isUserOnBuffer">
                    <button @click="kickUser" class="u-button u-button-secondary kick">
                        <i class="fa fa-sign-out" aria-hidden="true"></i>
                        {{$t('user_kick')}}
                    </button>
                </label>
                <label>
                    <button @click="banUser" class="u-button u-button-secondary ban">
                        <i class="fa fa-ban" aria-hidden="true"></i>
                        {{$t('user_ban')}}
                    </button>
                </label>
                <label v-if="isUserOnBuffer">
                    <button @click="kickbanUser" class="u-button u-button-secondary kickban">

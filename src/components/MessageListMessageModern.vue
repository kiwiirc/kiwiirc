...
.kiwi-messagelist-message--modern.kiwi-messagelist-message--authorrepeat.kiwi-messagelist-message-traffic {
    margin-right: 0;
    padding-left: 60px;
    padding-top: 0;
    padding-bottom: 0;
...
.kiwi-messagelist-message.kiwi-messagelist-message--unread.kiwi-messagelist-message-traffic {
    padding-top: 0;
}
